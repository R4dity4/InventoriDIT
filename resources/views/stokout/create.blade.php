...
<body>
  <div class="container">
    ...
    <a href="{{ route('stokouts.index') }}" class="btn btn-outline-primary btn-sm" style="width: 100px">Kembali</a><br><br>

    <form method="post" action="{{ route('stokouts.store') }}">
      @csrf
      ...
      <a href="{{ route('stokouts.index') }}" class="btn btn-secondary mt-3">Batal</a>
    </form>
  </div>
